...
# Simpan ke CSV
karyawan_df.to_csv('resources/karyawan.csv', index=False)
kehadiran_df.to_csv('resources/kehadiran.csv', index=False)
lembur_df.to_csv('resources/lembur.csv', index=False)
pelanggaran_df.to_csv('resources/pelanggaran.csv', index=False)
bonus_df.to_csv('resources/bonus.csv', index=False)
