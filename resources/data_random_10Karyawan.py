...
# Save to CSV files
df_karyawan.to_csv('resources/karyawan.csv', index=False)
df_kehadiran.to_csv('resources/kehadiran.csv', index=False)
df_lembur.to_csv('resources/lembur.csv', index=False)
df_pelanggaran.to_csv('resources/pelanggaran.csv', index=False)
df_bonus.to_csv('resources/bonus.csv', index=False)